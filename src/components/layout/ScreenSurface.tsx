import type { DashboardData, DetailPageKey, FollowersData, Language, RouteKey } from "../../types";
...
export function ScreenSurface({ route, language, t, followers, dashboard, loading, refresh, share, onSettings, openDetail, onBack }: {
  route:RouteKey; language:Language; t:Translator; followers:FollowersData; dashboard:DashboardData|null; loading:boolean; refresh:()=>void; share:()=>void; onSettings:()=>void; openDetail:(p:DetailPageKey)=>void; onBack:()=>void;
}) {
